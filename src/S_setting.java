...
public class S_setting extends JFrame {
    ...
    S_setting(){
        ...
        Font Qq0e3 = new Font ("Segoe UI",Font.PLAIN,12);
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        JLabel topic = new JLabel ("User Settings");
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        a.setIcon(new ImageIcon(getClass().getResource("img/S_setting.png")));
        add(a);
//---------------------------------------------------------------------------------------------------------------------------------------------------------------
